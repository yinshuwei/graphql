...
// will be returned.
func (c *Client) Run(ctx context.Context, req *Request, resp, errs interface{}) error {
	select {
	case <-ctx.Done():
		return ctx.Err()
	default:
...
func (c *Client) runWithJSON(ctx context.Context, req *Request, resp, errs interface{}) error {
...
func (c *Client) runWithPostFields(ctx context.Context, req *Request, resp, errs interface{}) error {
	var requestBody bytes.Buffer
